...
return new class extends Migration
{
    ...
    {
        Schema::create('t_r_committee_kinds', function (Blueprint $table) {
            $table->bigIncrements("id")->comment('システムID')->nullable(false);
            $table->integer("committeekinds_id")->comment('委員会種別ID')->nullable(false)->unique();
    ...
    {
        Schema::dropIfExists('t_r_committee_kinds');
    }
};
